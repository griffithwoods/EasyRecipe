...
const server = http.createServer((req,res) => {
    ...
    //load 127.0.0.1:1337, check network
    //http://127.0.0.1:1337/yinghao return /yinghao
    const pathName = url.parse(req.url,true).pathname; //return /hello
    ...
    if(pathName === '/products' || pathName === '/'){
        ...
        console.log('this is the laptop');
        res.writeHead(200,{'Content-type': 'text/html'});
